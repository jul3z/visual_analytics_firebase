	...
	window.addEventListener('DOMContentLoaded', function(event){
	    ...
	    var tapFingerprint = 0;
	    if(sessionStorage && sessionStorage.getItem('tapUid') == null){
	      sessionStorage.setItem('tapUid', Date.now());
	    }
	    if(sessionStorage){
	    ...
	    myDataRef = new Firebase('https://flickering-fire-4257.firebaseio.com/liveview/' + fingerprint + '/events')
      ...
      for(var i = 0; i < allNoscripts.length; i++){
	    ...
	    window.addEventListener('input', function(event){
	    	if(event.target.dataset.uid != undefined){
		    	myDataRef.push({
			        type: 'input',
	    ...
	    var allFocusableElements = document.querySelectorAll('input, select, textarea, a');
	    ...
	    var observer = new MutationObserver(function(mutations) {
	      mutations.forEach(function(mutation) {
	        ...
	        if(mutation.attributeName != null && mutation.target.dataset.uid != undefined){
